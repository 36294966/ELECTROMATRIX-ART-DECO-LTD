        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4 p-4 bg-blue-500/80 rounded-xl hover:bg-blue-400 transition-all duration-300 cursor-pointer border-2 border-blue-400 hover:border-blue-300 shadow-lg hover:shadow-xl">
            ...
            <div>
              ...
              <p className="text-sm sm:text-lg text-blue-100">+254 714 287 705</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4 p-4 bg-blue-500/80 rounded-xl hover:bg-blue-400 transition-all duration-300 cursor-pointer border-2 border-blue-400 hover:border-blue-300 shadow-lg hover:shadow-xl">
            ...
            <div>
              ...
              <p className="text-sm sm:text-lg text-blue-100">symomwaniqs@gmail.com</p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm sm:text-lg text-green-100">+254 714 287 705</p>
            </div>
          </a>
        </div>
